...
switch planet {
case .Mercury:
    print("Este el el planeta Mercurio")
case .Venus:
    print("Este es el planeta Venus")
case .Earth:
    print("Este es el planeta Tierra")
case .Mars:
    print("Este es el planeta Marte")
}
...
print(haveRead(books:books, book:book))
