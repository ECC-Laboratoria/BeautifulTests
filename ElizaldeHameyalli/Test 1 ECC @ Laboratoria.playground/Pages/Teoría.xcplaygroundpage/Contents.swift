...
/*
Respuesta:
 Recibe las ordenes y solicita información al control de Vistas.
 */

//: 2. ¿Qué puedes hacer dentro del archivo Main.storyboard?
/*
Respuesta:
 Colocar y manejar los elementos de UI
 */
...
Respuesta:
 ...
 - Outlet es para Componentes, como Labels, por ejemplo.
 - Action es para inputs, como botones o componentes que recibieran una acción.
 */

//: 4. ¿Menciona al menos una ventaja al utilizar UIStackView?
/*
Respuesta:
 Los elementos quedan alineados y permite
 */
